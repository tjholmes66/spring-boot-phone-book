...
import com.tomholmes.springboot.phonebook.server.service.LoginService;
import com.tomholmes.springboot.phonebook.server.util.SendEmailService;
...
public class LoginController
{
    ...
    public UserEntity login(@PathVariable("email") String email)
    {
        ...
        if (userEntity != null)
        {
            ...
            // emailService.sendMail("phonebook_app@tomholmes.net", userEntity.getEmail(), "Phonebook App - Found
            // Username", msgBody);
        }
        System.out.println("LoginController: login: FINISH: userEntity=" + userEntity);
        return userEntity;
